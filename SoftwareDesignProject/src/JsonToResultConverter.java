...
public class JsonToResultConverter {
    ...
    static ResultSkeleton getObjectFromJson(String json){
        Gson gson = new Gson();
        ResultSkeleton result = gson.fromJson(json, ResultSkeleton.class);
        return result;
    }

    static List<Result> convert(String json){
        ArrayList<Result> convertedResults = new ArrayList<>();
        ResultSkeleton jsonObj = getObjectFromJson(json);
    ...
    public static void main(String[] args) {
        ...
        List<Result> results = convert(json);
